...
/**
 * Write a description of class ThirdFloorTrapDoor here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class ThirdFloorTrapDoor extends TrapDoor
{
    ...
    private int state;
    public ThirdFloorTrapDoor(int state){
