...
public class Mike extends Character
{
    ...
    private double skill1DamageTakenMultiplier = 1.5;
    private int skill1ActiveTurns = 1;
    private int skill1SpCost = 10;

    private final String skill2Name="All Eyez On Me";
    private final int skill2Type=2;
    private int skill2ActiveTurns = 1;
    private int skill2SpCost = 7;
